...
INSERT INTO request_fee_parameter (id, valid_from, count_free_base, count_free_per_domain) VALUES (1, '2011-06-01', 25000, 100);
INSERT INTO price_list (zone, operation, valid_from, price, period) SELECT id, 3, '2011-06-01', 0.1, 0  FROM zone WHERE fqdn='cz';
