...
<?cs /if ?><?cs if:subcount(changes.contact.disclose) ?>Viditelnost údajů / Data visibility:
...
<?cs /if ?><?cs if:changes.nsset.dns.1 ?><?cs call:print_value_list(which, changes.nsset.dns, "Jmenný server / Name server") ?>
