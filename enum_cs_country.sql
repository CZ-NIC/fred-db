...
UPDATE enum_country SET country_cs= 'Ázerbajdžán'  WHERE ID= 'AZ' ;
...
UPDATE enum_country SET country_cs= 'Džibuti'  WHERE ID= 'DJ' ;
...
UPDATE enum_country SET country_cs= 'Jižní Georgie'  WHERE ID= 'GS' ;
...
UPDATE enum_country SET country_cs= 'Severní Korea (Korejská lidově demokratická republika)'  WHERE ID= 'KP' ;
...
UPDATE enum_country SET country_cs= 'Srbsko a Černá hora'  WHERE ID= 'CS' ;
...
UPDATE enum_country SET country_cs= 'Špicberky'  WHERE ID= 'SJ' ;
