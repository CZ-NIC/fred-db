...
CREATE TABLE registraracl (
  ...
  cert VARCHAR(1024) NOT NULL, -- certificate MD5 fingerprint in HEX format 'FA:09:...:73'
  password VARCHAR(1024) NOT NULL, -- password data
  uuid UUID NOT NULL UNIQUE DEFAULT gen_random_uuid(), -- external reference
  create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- creation time of the record
  cert_data_pem VARCHAR(16384), -- certificate data in PEM format
