...
Vážená paní, vážený pane,
do dnešního dne nedošlo k opravě údajů, které jsou uvedeny u kontaktu id <?cs var:contact_handle ?>. Zásilka odeslaná na adresu uvedenou u tohoto kontaktu v centrálním registru, se vrátila s informací od pošty "adresát na uvedené adrese neznámý (volné pole pro dopisování)".
...
Dear Sirs,
let us inform you that up to this day the data set to the contact id <?cs var:contact_handle ?> have not been corrected yet. The letter sent to the address set in the contact in central registry has returned with this information from the post office "adressee at the mentioned address unknown (free field for correspondence)".
