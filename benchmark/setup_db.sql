...
UPDATE enum_country SET country_cs= 'Afgh�nist�n'  WHERE ID= 'AF' ;
UPDATE enum_country SET country_cs= 'Alb�nie'  WHERE ID= 'AL' ;
UPDATE enum_country SET country_cs= 'Al��rsko'  WHERE ID= 'DZ' ;
UPDATE enum_country SET country_cs= 'Americk� Samoa'  WHERE ID= 'AS' ;
UPDATE enum_country SET country_cs= 'Americk� Panensk� ostrovy'  WHERE ID= 'VI' ;
...
UPDATE enum_country SET country_cs= 'Arm�nie'  WHERE ID= 'AM' ;
UPDATE enum_country SET country_cs= 'Aruba'  WHERE ID= 'AW' ;
UPDATE enum_country SET country_cs= 'Austr�lie'  WHERE ID= 'AU' ;
UPDATE enum_country SET country_cs= '�zerbajd��n'  WHERE ID= 'AZ' ;
UPDATE enum_country SET country_cs= 'Bahamy'  WHERE ID= 'BS' ;
UPDATE enum_country SET country_cs= 'Bahrajn'  WHERE ID= 'BH' ;
UPDATE enum_country SET country_cs= 'Banglad�'  WHERE ID= 'BD' ;
...
UPDATE enum_country SET country_cs= 'B�lorusko'  WHERE ID= 'BY' ;
UPDATE enum_country SET country_cs= 'Benin'  WHERE ID= 'BJ' ;
UPDATE enum_country SET country_cs= 'Bermudy'  WHERE ID= 'BM' ;
UPDATE enum_country SET country_cs= 'Bh�t�n'  WHERE ID= 'BT' ;
UPDATE enum_country SET country_cs= 'Bol�vie'  WHERE ID= 'BO' ;
...
UPDATE enum_country SET country_cs= 'Braz�lie'  WHERE ID= 'BR' ;
UPDATE enum_country SET country_cs= 'Britsk� indickooce�nsk� teritorium'  WHERE ID= 'IO' ;
UPDATE enum_country SET country_cs= 'Britsk� Panensk� ostrovy'  WHERE ID= 'VG' ;
...
UPDATE enum_country SET country_cs= '�ad'  WHERE ID= 'TD' ;
UPDATE enum_country SET country_cs= '�esk� republika'  WHERE ID= 'CZ' ;
UPDATE enum_country SET country_cs= '��na'  WHERE ID= 'CN' ;
UPDATE enum_country SET country_cs= 'D�nsko'  WHERE ID= 'DK' ;
UPDATE enum_country SET country_cs= 'Dominika'  WHERE ID= 'DM' ;
UPDATE enum_country SET country_cs= 'Dominik�nsk� republika'  WHERE ID= 'DO' ;
UPDATE enum_country SET country_cs= 'D�ibuti'  WHERE ID= 'DJ' ;
UPDATE enum_country SET country_cs= 'Egypt'  WHERE ID= 'EG' ;
UPDATE enum_country SET country_cs= 'Ekv�dor'  WHERE ID= 'EC' ;
...
UPDATE enum_country SET country_cs= 'Faersk� ostrovy'  WHERE ID= 'FO' ;
UPDATE enum_country SET country_cs= 'Falklandy'  WHERE ID= 'FK' ;
UPDATE enum_country SET country_cs= 'Fid�i'  WHERE ID= 'FJ' ;
UPDATE enum_country SET country_cs= 'Filip�ny'  WHERE ID= 'PH' ;
UPDATE enum_country SET country_cs= 'Finsko'  WHERE ID= 'FI' ;
UPDATE enum_country SET country_cs= 'Francie'  WHERE ID= 'FR' ;
UPDATE enum_country SET country_cs= 'Francouzsk� Guyana'  WHERE ID= 'GF' ;
UPDATE enum_country SET country_cs= 'Francouzsk� Polyn�zie'  WHERE ID= 'PF' ;
UPDATE enum_country SET country_cs= 'Francouzsk� ji�n� �zem�'  WHERE ID= 'TF' ;
...
UPDATE enum_country SET country_cs= 'Gr�nsko'  WHERE ID= 'GL' ;
...
UPDATE enum_country SET country_cs= 'Indon�zie'  WHERE ID= 'ID' ;
UPDATE enum_country SET country_cs= 'Ir�k'  WHERE ID= 'IQ' ;
UPDATE enum_country SET country_cs= '�r�n'  WHERE ID= 'IR' ;
UPDATE enum_country SET country_cs= 'Irsko'  WHERE ID= 'IE' ;
UPDATE enum_country SET country_cs= 'Island'  WHERE ID= 'IS' ;
UPDATE enum_country SET country_cs= 'It�lie'  WHERE ID= 'IT' ;
...
UPDATE enum_country SET country_cs= 'Jihoafrick� republika'  WHERE ID= 'ZA' ;
UPDATE enum_country SET country_cs= 'Ji�n� Georgie'  WHERE ID= 'GS' ;
UPDATE enum_country SET country_cs= 'Jord�nsko'  WHERE ID= 'JO' ;
UPDATE enum_country SET country_cs= 'Kajmansk� ostrovy'  WHERE ID= 'KY' ;
...
UPDATE enum_country SET country_cs= 'Kazachst�n'  WHERE ID= 'KZ' ;
UPDATE enum_country SET country_cs= 'Ke�a'  WHERE ID= 'KE' ;
UPDATE enum_country SET country_cs= 'Kiribati'  WHERE ID= 'KI' ;
UPDATE enum_country SET country_cs= 'Kolumbie'  WHERE ID= 'CO' ;
UPDATE enum_country SET country_cs= 'Kokosov� ostrovy'  WHERE ID= 'CC' ;
UPDATE enum_country SET country_cs= 'Komory'  WHERE ID= 'KM' ;
UPDATE enum_country SET country_cs= 'Kongo'  WHERE ID= 'CG' ;
UPDATE enum_country SET country_cs= 'Kongo (Demokratick� republika Kongo)'  WHERE ID= 'CD' ;
UPDATE enum_country SET country_cs= 'Severn� Korea (Korejsk� lidov� demokratick� republika)'  WHERE ID= 'KP' ;
UPDATE enum_country SET country_cs= 'Korea (Korejsk� republika)'  WHERE ID= 'KR' ;
...
UPDATE enum_country SET country_cs= 'Kyrgyzst�n'  WHERE ID= 'KG' ;
...
UPDATE enum_country SET country_cs= 'Lib�rie'  WHERE ID= 'LR' ;
...
UPDATE enum_country SET country_cs= 'Ma�arsko'  WHERE ID= 'HU' ;
...
UPDATE enum_country SET country_cs= 'Mauret�nie'  WHERE ID= 'MR' ;
...
UPDATE enum_country SET country_cs= 'Mikron�sie'  WHERE ID= 'FM' ;
...
UPDATE enum_country SET country_cs= 'Nam�bie'  WHERE ID= 'NA' ;
UPDATE enum_country SET country_cs= 'Nauru'  WHERE ID= 'NR' ;
UPDATE enum_country SET country_cs= 'N�mecko'  WHERE ID= 'DE' ;
UPDATE enum_country SET country_cs= 'Nep�l'  WHERE ID= 'NP' ;
UPDATE enum_country SET country_cs= 'Niger'  WHERE ID= 'NE' ;
UPDATE enum_country SET country_cs= 'Nig�rie'  WHERE ID= 'NG' ;
UPDATE enum_country SET country_cs= 'Nikaragua'  WHERE ID= 'NI' ;
UPDATE enum_country SET country_cs= 'Nizozem�'  WHERE ID= 'NL' ;
UPDATE enum_country SET country_cs= 'Nizozemsk� Antily'  WHERE ID= 'AN' ;
...
UPDATE enum_country SET country_cs= 'Nov� Kaledonie'  WHERE ID= 'NC' ;
UPDATE enum_country SET country_cs= 'Nov� Z�land'  WHERE ID= 'NZ' ;
UPDATE enum_country SET country_cs= 'Om�n'  WHERE ID= 'OM' ;
UPDATE enum_country SET country_cs= 'P�kist�n'  WHERE ID= 'PK' ;
...
UPDATE enum_country SET country_cs= 'Papua Nov� Guinea'  WHERE ID= 'PG' ;
...
UPDATE enum_country SET country_cs= 'Pob�e�� slonoviny'  WHERE ID= 'CI' ;
...
UPDATE enum_country SET country_cs= 'R�union'  WHERE ID= 'RE' ;
UPDATE enum_country SET country_cs= 'Rovn�kov� Guinea'  WHERE ID= 'GQ' ;
...
UPDATE enum_country SET country_cs= '�ecko'  WHERE ID= 'GR' ;
...
UPDATE enum_country SET country_cs= 'Sa�dsk� Ar�bie'  WHERE ID= 'SA' ;
UPDATE enum_country SET country_cs= 'Senegal'  WHERE ID= 'SN' ;
UPDATE enum_country SET country_cs= 'Severn� Mariany'  WHERE ID= 'MP' ;
...
UPDATE enum_country SET country_cs= 'Som�lsko'  WHERE ID= 'SO' ;
UPDATE enum_country SET country_cs= 'Spojen� arabsk� emir�ty'  WHERE ID= 'AE' ;
UPDATE enum_country SET country_cs= 'Spojen� st�ty americk�'  WHERE ID= 'US' ;
UPDATE enum_country SET country_cs= 'Srbsko a �ern� hora'  WHERE ID= 'CS' ;
UPDATE enum_country SET country_cs= 'Sr� Lanka (Cejlon)'  WHERE ID= 'LK' ;
UPDATE enum_country SET country_cs= 'St�edoafrick� republika'  WHERE ID= 'CF' ;
UPDATE enum_country SET country_cs= 'S�d�n'  WHERE ID= 'SD' ;
UPDATE enum_country SET country_cs= 'Surinam'  WHERE ID= 'SR' ;
UPDATE enum_country SET country_cs= 'Svat� Helena'  WHERE ID= 'SH' ;
UPDATE enum_country SET country_cs= 'Svat� Lucie'  WHERE ID= 'LC' ;
UPDATE enum_country SET country_cs= 'Svazijsko'  WHERE ID= 'SZ' ;
UPDATE enum_country SET country_cs= 'S�rie'  WHERE ID= 'SY' ;
UPDATE enum_country SET country_cs= '�alomounovy ostrovy'  WHERE ID= 'SB' ;
UPDATE enum_country SET country_cs= '�pan�lsko'  WHERE ID= 'ES' ;
UPDATE enum_country SET country_cs= '�picberky'  WHERE ID= 'SJ' ;
UPDATE enum_country SET country_cs= '�v�dsko'  WHERE ID= 'SE' ;
UPDATE enum_country SET country_cs= '�v�carsko'  WHERE ID= 'CH' ;
UPDATE enum_country SET country_cs= 'T�d�ikist�n'  WHERE ID= 'TJ' ;
UPDATE enum_country SET country_cs= 'Tanz�nie'  WHERE ID= 'TZ' ;
...
UPDATE enum_country SET country_cs= 'Turkmenist�n'  WHERE ID= 'TM' ;
...
UPDATE enum_country SET country_cs= 'Uzbekist�n'  WHERE ID= 'UZ' ;
UPDATE enum_country SET country_cs= 'V�no�n� ostrov'  WHERE ID= 'CX' ;
UPDATE enum_country SET country_cs= 'Vanuatu'  WHERE ID= 'VU' ;
UPDATE enum_country SET country_cs= 'Vatik�n'  WHERE ID= 'VA' ;
UPDATE enum_country SET country_cs= 'Velk� Brit�nie a Severn� Irsko'  WHERE ID= 'GB' ;
UPDATE enum_country SET country_cs= 'Venezuela'  WHERE ID= 'VE' ;
UPDATE enum_country SET country_cs= 'Vietnam'  WHERE ID= 'VN' ;
UPDATE enum_country SET country_cs= 'V�chodn� timor'  WHERE ID= 'TL' ;
UPDATE enum_country SET country_cs= 'Wallisovy ostrovy'  WHERE ID= 'WF' ;
UPDATE enum_country SET country_cs= 'Zambie'  WHERE ID= 'ZM' ;
UPDATE enum_country SET country_cs= 'Z�padn� Sahara'  WHERE ID= 'EH' ;
